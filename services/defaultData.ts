...
export const DEFAULT_FORMULAS: Formula[] = [
  {
    ...
    steps: [
      ...
      'Bước 2: Hợp nhất Năng lượng Tình thương, Trí tuệ, Hiểu biết vào Trái Tim Linh Hồn, vào Linh Quang Não Bộ và toàn bộ cột sống đến tận xương cùng (3 lần).',
  ...
  },
  {
    ...
    subtitle: 'Thời gian: 3 phút 30 giây - Thực hiện 1 lần/ngày',
    durationSeconds: 210,
    iconType: 'user',
    steps: [
      ...
      'Bước 2: Hợp nhất Năng lượng Tình thương, Trí tuệ, Hiểu biết vào Trái Tim Linh Hồn, vào Linh Quang Não Bộ và toàn bộ cơ thể (3 lần).',
  ...
  },
  {
    ...
    subtitle: '8-12t: 1p | 13-18t: 1p30s | >18t: 3p30s',
    durationSeconds: 210,
    iconType: 'heart',
    steps: [
      'Bước 1: Hợp nhất Năng lượng Tình thương, Trí tuệ, Hiểu biết vào Trái Tim Linh Hồn, vào Linh Quang Não Bộ và toàn bộ cơ thể (3 lần).',
  ...
  },
  {
    ...
    title: 'Lớp 5.6 - Công Thức 13 Phút 30 Giây',
    subtitle: 'Thanh lọc độc tố & Hóa giải nghiệp lực',
    durationSeconds: 810, 
    iconType: 'zap',
    steps: [
      'Bước 1: Hợp nhất Năng lượng Tình thương, Trí tuệ, Hiểu biết vào Trái Tim Linh Hồn, vào Linh Quang Não Bộ và toàn bộ cơ thể (3 lần).',
