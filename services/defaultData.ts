...
export const DEFAULT_FORMULAS: Formula[] = [
  {
    id: 'toa-sang-nlg-toan-than',
    title: 'CÔNG THỨC TOẢ SÁNG NLG TOÀN THÂN',
  ...
  {
    id: 'kich-thich-te-bao-18-39',
    title: 'CÔNG THỨC KÍCH THÍCH TẾ BÀO TOÀN THÂN BẢO TOÀN THANH XUÂN',
    subtitle: 'Dành cho người từ 18 – 39 tuổi | 3 phút 30 giây | 1 – 2 lần/ngày',
    durationSeconds: 210,
    iconType: 'zap',
    steps: [
      '- Hợp nhất NLG LQVT KNM Băng Tần 13+ vào Linh Quang Não Bộ (3 lần)',
      '- Hợp nhất năng lượng từ Linh Quang Não Bộ vào tế bào não, tế bào gốc, tế bào toàn thân. (3 lần)',
      'NLG LQVT KNM Băng Tần 13+ Nâng cấp tế bào năng lượng Linh Quang Não Bộ kích thích tế bào não, tế bào gốc, tế bào toàn thân, bảo toàn thanh xuân, sống khỏe mạnh đến 120 tuổi. Liên tục điều phối năng lượng từ Linh Quang Não Bộ vào tế bào não, tế bào gốc, tế bào toàn thân để cung ứng đầy đủ năng lượng cho tế bào thực hiện tốt nhiệm vụ trong suốt thời gian thực hiện.'
    ]
  },
  {
    id: 'kich-thich-te-bao-40-plus',
    title: 'CÔNG THỨC KÍCH THÍCH TẾ BÀO TOÀN THÂN TRỞ LẠI THANH XUÂN',
    subtitle: 'Dành cho người từ 40 tuổi trở lên | 3 phút 30 giây | 1 – 2 lần/ngày',
    durationSeconds: 210,
    iconType: 'zap',
    steps: [
      '- Hợp nhất NLG LQVT KNM Băng Tần 13+ vào Linh Quang Não Bộ. (3 lần)',
      '- Hợp nhất năng lượng từ Linh Quang Não Bộ vào tế bào não, tế bào gốc, tế bào toàn thân. (3 lần)',
      'NLG LQVT KNM Băng Tần 13+ Nâng cấp tế bào năng lượng Linh Quang Não Bộ kích thích tế bào não, tế bào gốc, tế bào toàn thân, trở lại thời kỳ thanh xuân lúc (18/19/20/21) tuổi; sống khỏe mạnh đến 120 tuổi. Liên tục điều phối năng lượng từ Linh Quang Não Bộ vào tế bào não, tế bào gốc, tế bào toàn thân để cung ứng đầy đủ năng lượng cho tế bào thực hiện tốt nhiệm vụ trong suốt thời gian thực hiện.'
    ]
  },
  {
    id: 'chua-lanh-ban-than',
    title: 'CÔNG THỨC CHỮA LÀNH BẢN THÂN',
    subtitle: '3 phút 30 giây | Nhẹ: 1-2 lần/ngày | Nặng: 3 lần/ngày',
    durationSeconds: 210,
    iconType: 'heart',
    steps: [
      'BƯỚC 1:',
  ...
  {
    id: 'chua-lanh-khan-cap',
    title: 'CÔNG THỨC CHỮA LÀNH BẢN THÂN KHẨN CẤP',
    subtitle: 'Thực hiện 1 phút 30 giây',
    durationSeconds: 90,
    iconType: 'heart',
    steps: [
  ...
  {
    id: 'chua-lanh-1-nguoi-tap-the',
    title: 'CÔNG THỨC CHỮA LÀNH 1 NGƯỜI/TẬP THỂ',
    subtitle: 'Trực tiếp/Từ xa/Qua ảnh | Trên 18 tuổi: 3 phút 30 giây',
    durationSeconds: 210,
    iconType: 'user',
    steps: [
      'BƯỚC 1:',
      ...
      '- Hợp nhất năng lượng từ Linh Quang Não Bộ người truyền vào tế bào não, tế bào gốc, tế bào toàn thân của người nhận/tập thể người nhận. (3 lần)',
      '- NLG LQVT KNM Băng Tần 13+ hoá giải toàn bộ tác nhân gây bệnh tật, bổ sung NL chữa lành, phục hồi sức khỏe toàn diện cho người nhận/tập thể người nhận, giúp ngăn ngừa tắc nghẽn hệ thần kinh não bộ, hệ tuần hoàn tim mạch; ngăn chặn các tác nhân hình thành cục máu đông trong cơ thể; giúp hệ thống chuyển hoá hoạt động tích cực, ổn định huyết áp, đường huyết nằm trong chỉ số an toàn. Liên tục điều phối năng lượng trong suốt thời gian truyền.',
      'BƯỚC 2: Cầu nguyện cho tất cả tầng năng lượng hiện diện xung quanh có duyên nghiệp, nương theo NLG trở về Khối Sáng để được thăng tiến lên tầng cao hơn trong hành trình tiến hóa.'
    ]
  },
  {
    id: 'thoi-gian-13-phut-30-giay',
    title: 'CÔNG THỨC THỜI GIAN 13 PHÚT 30 GIÂY',
    subtitle: 'Thực hiện 13 phút 30 giây | 1 - 2 lần/ngày',
    durationSeconds: 810,
    iconType: 'timer',
    steps: [
      '- Hợp nhất NLG LQVT KNM Băng Tần 13+ vào Linh Quang Não Bộ (3 lần)',
      '- Hợp nhất năng lượng từ Linh Quang Não Bộ vào tế bào não, tế bào gốc, tế bào toàn thân. (3 lần)',
      'Liên tục truyền tải năng lượng từ đỉnh đầu đến bàn chân rồi đi ra ngoài, lặp đi lặp lại cho đến khi chuông báo hết giờ.',
  ...
  {
    id: 'hoa-giai-tinh-duyen',
    title: 'CÔNG THỨC HOÁ GIẢI LỜI HỨA LỜI NGUYỆN TÌNH DUYÊN',
    ...
    steps: [
      'BƯỚC 1:',
      '- Hợp nhất NLG LQVT KNM Băng Tần 13+ vào Linh Quang Não Bộ. (3 lần)',
      '- Hợp nhất năng lượng từ Linh Quang Não Bộ đến tất cả tâm linh có duyên nghiệp từ vô lượng kiếp đến hiện tại. (3 lần)',
      'NLG LQVT KNM Băng Tần 13+ Hóa giải lời hứa, lời nguyện tình duyên. Lòng tôi đầy thống hối, ăn năn về sự bất như ý của tình duyên trước đây đã làm tổn thương đến các vị. Cầu xin các vị tha thứ, buông xả, hoá giải sân hận, khổ đau, nương theo NLG trở về Khối Sáng để được thăng tiến lên tầng cao hơn trong hành trình tiến hoá. Mong NVMNKG minh chứng và tài trợ phước đức.',
      'BƯỚC 2: Cầu nguyện cho tất cả tầng năng lượng hiện diện xung quanh có duyên nghiệp, nương theo NLG trở về Khối Sáng để được thăng tiến lên tầng cao hơn trong hành trình tiến hóa.'
    ]
  },
  {
    id: 'cau-nguyen-to-tien',
    title: 'CÔNG THỨC CẦU NGUYỆN CHO TỔ TIÊN VÀ CON YÊU YỂU MỆNH TỪ VÔ LƯỢNG KIẾP',
    subtitle: '3 phút 30 giây | 1 lần/ngày, liên tục trong 3 ngày rồi ngưng',
    durationSeconds: 210,
    iconType: 'users',
    steps: [
      'BƯỚC 1:',
      '- Hợp nhất NLG LQVT KNM Băng Tần 13+ vào Linh Quang Não Bộ. (3 lần)',
      '- Hợp nhất năng lượng từ Linh Quang Não Bộ hướng về tất cả tổ tiên và tất cả con yêu yểu mệnh từ vô lượng kiếp tới hiện tại. (3 lần)',
      'NLG LQVT KNM Băng Tần 13+ Cầu nguyện cho tất cả tổ tiên và tất cả con yêu yểu mệnh từ vô lượng kiếp tới hiện tại. Kính xin Nền Văn Minh Ngoài Không Gian ban phước báu, phục hồi và bổ sung linh lượng cho tất cả tổ tiên và tất cả con yêu yểu mệnh từ vô lượng kiếp tới hiện tại. (Tâm sự với tất cả tổ tiên và tất cả con yêu yểu mệnh từ vô lượng kiếp tới hiện tại, cho đến khi chuông báo hết giờ.)',
      'BƯỚC 2: Cầu nguyện cho tất cả tầng năng lượng hiện diện xung quanh có duyên nghiệp, nương theo NLG trở về Khối Sáng để được thăng tiến lên tầng cao hơn trong hành trình tiến hóa.'
    ]
  },
  {
    id: 'hoa-giai-thanh-loc-doc-to',
    title: 'CÔNG THỨC HÓA GIẢI THANH LỌC ĐỘC TỐ CHO 1 NGƯỜI/TẬP THỂ',
    subtitle: 'Trên 18 tuổi: 3 phút 30 giây | Trực tiếp/Từ xa/Qua ảnh',
    durationSeconds: 210,
    iconType: 'shield',
    steps: [
      'BƯỚC 1:',
      ...
      '- Hợp nhất năng lượng từ Linh Quang Não Bộ người truyền vào não bộ của người nhận/tập thể người nhận. (3 lần)',
      '- Hợp nhất năng lượng từ Linh Quang Não Bộ người truyền vào tế bào não, tế bào gốc, tế bào toàn thân của người nhận/tập thể người nhận. (3 lần)',
      'NLG LQVT KNM Băng Tần 13+ Phục hồi toàn diện hệ thống chuyển hóa, hóa giải thanh lọc (miễn nhiễm) các loại độc tố, thải độc cơ thể, hóa giải thư yếm bùa ngải, đem lại sự an lành, sức sống thanh xuân trường thọ cho người nhận/tập thể người nhận.',
      'Liên tục truyền tải năng lượng từ bàn chân đến đỉnh đầu người nhận/tập thể người nhận rồi đi ra ngoài trong suốt thời gian thực hiện.',
      'BƯỚC 2: Cầu nguyện cho tất cả tầng năng lượng hiện diện xung quanh có duyên nghiệp, nương theo NLG trở về Khối Sáng để được thăng tiến lên tầng cao hơn trong hành trình tiến hóa.'
    ]
  },
  {
    id: 'chua-lanh-rang-mieng',
    title: 'CÔNG THỨC CHỮA LÀNH BỆNH RĂNG MIỆNG CHO BẢN THÂN',
    subtitle: 'Bệnh nặng: 3 phút 30 giây | 1 lần/ngày',
    durationSeconds: 210,
    iconType: 'smile',
    steps: [
      'BƯỚC 1:',
      '- Hợp nhất NLG LQVT KNM Băng Tần 13+ vào Linh Quang Não Bộ. (3 lần)',
      '- Hợp nhất năng lượng từ LQNB vào tế bào não, tế bào gốc, tế bào toàn thân và tế bào vùng răng miệng. (3 lần)',
      'NLG LQVT KNM Băng Tần 13+ Điều chỉnh các gen hư lỗi, các tế bào khiếm khuyết, tổn thương, phục hồi nội lực, chức năng các tế bào, chữa lành bệnh răng miệng như: viêm lưỡi, viêm nướu, tụt nướu, chảy máu chân răng, hôi miệng; tiêu xương răng, lung lay răng; giãn dây chằng quanh răng, viêm cuống răng, sâu răng … giúp nướu răng và xương hàm răng phục hồi chắc khỏe cho chính mình.',
  ...
  },
  {
    ...
    steps: [
      '- Hợp nhất NLG LQVT KNM Băng Tần 13+ vào LQNB người truyền. (3 lần)',
      '- Hợp nhất năng lượng từ Linh Quang Não Bộ người truyền vào não bộ của người nhận/tập thể người nhận. (3 lần)',
      'NLG LQVT KNM Băng Tần 13+ Cảm hoá (người A, B, C…) sống tích cực thiện lành:',
      '- Bớt: chơi game, uống rượu, lướt web,..…',
      '- Thương yêu cha mẹ, vợ/chồng, con cái và tất cả mọi người.',
      '- Tích cực học tập để có kiến thức xây dựng tương lai được đủ đầy, hạnh phúc',
      '- Không sân giận, không thù ghét, không thực hiện những suy nghĩ, lời nói, việc làm, những hành vi làm tổn thương người khác. Luôn vui khỏe hạnh phúc.',
      'Liên tục gửi những thông điệp cảm hóa … từ Linh Quang Não Bộ người truyền đến não bộ của người nhận/tập thể người nhận trong suốt thời gian thực hiện'
    ]
  },
  {
    id: 'lam-dep-lan-da',
    title: 'CÔNG THỨC LÀM ĐẸP LÀN DA',
    ...
    steps: [
      '- Hợp nhất NLG LQVT KNM Băng Tần 13+ vào Linh Quang Não Bộ. (3 lần)',
      '- Hợp nhất năng lượng từ Linh Quang Não Bộ vào tế bào não, tế bào gốc, tế bào toàn thân. (3 lần)',
      'NLG LQVT KNM Băng Tần 13+ Làm đẹp làn da…',
      '1, Giúp làn da toàn thân săn chắc, căng bóng, sáng mịn hồng hào.',
      '2, Xóa nếp nhăn, vết thâm, nám, mụn, sẹo, tàn nhang,…',
      '3, Giúp thu nhỏ lỗ chân lông.',
      'Liên tục gửi thông điệp mong muốn cải thiện để tế bào não điều hành các tế bào gốc, tế bào toàn thân thực hiện.'
    ]
  },
  {
    id: 'chinh-sua-khuon-mat',
    title: 'CÔNG THỨC CHỈNH SỬA KHUÔN MẶT',
    subtitle: 'Thực hiện 3 phút 30 giây | 1 lần/ngày',
    durationSeconds: 210,
    iconType: 'user',
    steps: [
      '- Hợp nhất NLG LQVT KNM Băng Tần 13+ vào Linh Quang Não Bộ. (3 lần)',
      '- Hợp nhất năng lượng từ Linh Quang Não Bộ vào tế bào não, tế bào gốc, tế bào toàn thân. (3 lần)',
      'NLG LQVT KNM Băng Tần 13+ Làm đẹp khuôn mặt/Làm đẹp đôi mắt/ ….',
      'Liên tục gửi năng lượng cùng thông điệp đến vùng muốn cải thiện để tế bào não điều hành các tế bào gốc, tế bào toàn thân thực hiện chỉnh sửa, làm đẹp:',
      '1, Chỉnh sửa làm đẹp đôi mắt: làm tan mỡ bọng mắt và mí mắt, nâng mí mắt, hai mắt bằng nhau, mắt sáng long lanh…',
      '2, Làm đầy những chỗ lõm trên khuôn mặt, nâng cơ mặt hai bên , nâng cơ mí mắt….',
      '3, Chỉnh sửa khuôn mặt, tạo khuôn mặt trái xoan/khuôn mặt chữ điền…'
    ]
  },
  {
  ...
  },
  {
    ...
    steps: [
      '- Hợp nhất NLG LQVT KNM Băng Tần 13+ vào Linh Quang Não Bộ. (3 lần)',
      '- Hợp nhất năng lượng từ Linh Quang Não Bộ vào tế bào não, tế bào gốc, tế bào toàn thân. (3 lần)',
      '- Hợp nhất năng lượng từ Linh Quang Não Bộ vào vùng rốn. (3 lần)',
      'NLG LQVT KNM Băng Tần 13+ Tăng chiều cao … cm.',
      'Lấy rốn làm điểm giữa, liên tục điều phối năng lượng từ vùng rốn kéo dài khung xương theo 2 chiều trong suốt thời gian thực hiện.'
    ]
  },
  {
    id: 'bao-ve-mai-am-gia-dinh',
    title: 'CÔNG THỨC BẢO VỆ MÁI ẤM GIA ĐÌNH',
    subtitle: '3 phút 30 giây | Chỉ cần thực hiện 1 lần duy nhất',
    durationSeconds: 210,
    iconType: 'home',
    steps: [
      '- Hợp nhất NLG LQVT KNM Băng Tần 13+ vào Linh Quang Não Bộ (3 lần).',
      '- Hợp nhất năng lượng từ Linh Quang Não Bộ vào não bộ của tất cả những người thân (3 lần)',
      'NLG LQVT KNM Băng Tần 13+ Bảo vệ mái ấm gia đình hạnh phúc bằng tình thương yêu, sự giác ngộ của bản thân trong Văn Minh Kỷ Cương. Xin được lấy 1% phước báu của bản thân gửi tặng cho tất cả người thân trong gia đình mình.',
      'Liên tục truyền tải năng lượng vào tập thể người thân trong suốt thời gian thực hiện.'
    ]
  },
  {
  ...
  },
  {
    ...
    steps: [
      'BƯỚC 1:',
      '- Hợp nhất NLG LQVT KNM Băng Tần 13+ vào LQNB. (3 lần)',
      '- Hợp nhất Năng lượng từ LQNB người truyền vào: một người/tập thể/… /tất cả đẳng cấp TL hai giới trên vùng đất/quốc gia/toàn cầu từ vô lượng kiếp đến hiện tại (3 lần)',
